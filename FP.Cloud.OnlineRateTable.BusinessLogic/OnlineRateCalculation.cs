    ...
    public class OnlineRateCalculation : IRateCalculation
    {
        ...
        private DescriptionInfo GetRandomDescription()
        {
            DescriptionInfo[] descriptions = new DescriptionInfo[]
            {
                ...
                new RequestDescriptionInfo()
                {
                    DescriptionTitle = "Please enter a value",
                    DisplayFormat = @"$%2u.%2u",
                    Label = 2,
                    StatusMessage = "Request Value Status message"
                },
                new SelectIndexDescriptionInfo()
                {
                    DescriptionTitle = "Please select an index",
                    IndexEntries = new List<string>() {"IndexItem1", "IndexItem2", "IndexItem3" }
                },
                new DescriptionInfo()
                {
                    DescriptionTitle = "Please read and acknowledge this text",
                },
            };
